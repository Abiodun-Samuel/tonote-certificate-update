            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-9 col-lg-7">
                    <div class="page-header-content text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-dark mb-0">Privacy Policy</h1>
                        <div class="custom-breadcrumb text-dark">
                            <ol class="breadcrumb d-inline-block bg-transparent text-dark list-inline py-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active text-black-50">Privacy Policy</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        <h5>Introduction</h5>
                        <p>
                            Welcome to <a href="https://tonote.regnant.com.ng/">ToNote Technologies Limited</a> (“ToNote”, “We”, “Our” or “Us”)
                            Privacy Policy.
                        </p>
                        <p>
                            We respect your privacy and are committed to protecting your Personal Data. This Privacy
                            Policy will inform you as to how we collect, use, share and look after your Personal Data
                            when you visit our Platform (regardless of where you visit it from) or use any of our
                    ...
                    <div class="single-faq">
                        ...
                        <ul class="list-unstyled support-list">
                            <li class="mb-2 d-flex align-items-start mb-4">
                                ...
                                Detail Commercial Solicitors is the designated Data Protection Officer of the Company
                                who will be responsible for compliance with this policy and relevant data protection
                                legislation.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-1">
                                <span class="ti-check-box mr-2"></span>
                                If you have any questions about this Privacy Policy or our privacy practices, please
                                contact our Data Protection Officer in the following ways:

                            </li>
                            <li class="list-group-item">
                                Name: Detail Commercial Solicitors<br>
                                Email address: info@detailsolicitors.com<br>
                                Office Address: DCS Place, 8 DCS Street, Off Remi Olowude Way, Lekki Phase 1, Lagos<br>
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <p>
                            We may collect personal data i.e., any information relating to an identified or identifiable
                            ...
                            natural person; It can be anything from a name, address, a photo, an email address, bank
                            details, posts on social networking websites, medical information, and other unique
                            identifier such as but not limited to MAC address, IP address, IMEI number, IMSI number,
                            SIM, Personal Identifiable Information (PII) and others
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <ul class="list-unstyled support-list">
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                We may collect your Personal Data using forms, email and physical requests, cookies,
                                JWT, web tokens, or third-party applications. You can set your browser to refuse all or
                                some browser cookies, or to alert you if we access cookies. If you disable or refuse
                                cookies, please note that some parts of this Website may become inaccessible or not
                                function properly.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                We use your Personal Data for, verification of your identity; human resources
                                management; access to computer systems and third-party software; know-your-customer and
                                due diligence purposes; recruitment purposes; regulatory compliance; performance of a
                                contract with you; compliance with legal obligation; marketing; litigation; events
                                planning and hosting; in-house security; research, analysis, and other business purposes
                                or legitimate interests.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                When you send email or other communications to us, we may retain those communications to
                                process your inquiries, respond to your requests or improve our services provided on our
                                Platform. We may also collect information while providing our services to you. Our
                                servers automatically record information that your browser sends whenever you visit our
                                Platform.
                            </li>
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <ul class="list-unstyled support-list">
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                We will obtain your consent prior to collecting or processing your Personal Data. Where
                                we intend to use the information for a purpose other than the purpose for which it was
                                collected, prior to such use, we will request your consent.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                No consent shall be sought, given or accepted in any circumstance that may engender
                                direct or indirect propagation of atrocities, hate, child rights violation, criminal
                                acts and anti-social conducts.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                You may withdraw your consent at any time and may request access to your Personal Data
                                in our possession. Such withdrawal will not affect the lawfulness of the processing of
                                your Personal Data prior to the withdrawal of your consent. We can, however, deny you
                                access to the information where we determine that your request is unreasonable.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                You have the right to request the modification or amendment of your Personal Data in our
                                possession.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                In all cases of access or request for modification or amendment of Personal Data, we
                                shall request sufficient identification to enable us to confirm that you are the owner
                                of the data sought to be accessed, modified or amended.
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                Where you provide the Personal Data of a third party to us, you confirm to us that you
                                have informed the owner of the data about the purpose for which the data is required and
                                that you have obtained the consent of the owner of the data to provide the data to us
                                for the purpose for which it is required and in accordance with this Privacy Policy.
                            </li>
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <p>
                            When we process Personal Data, we are guided by the following principles. Personal Data
                            shall be:
                        </p>
                        <ul class="list-unstyled support-list">
                            <li class="mb-2 d-flex align-items-start mb-4">
                            ...
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                processed lawfully for the purpose for which it was collected and not further processed
                                in a manner incompatible with which that purpose(s);
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                processed adequately, accurately and without prejudice to the dignity of the human
                                person;
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                adequate, relevant and limited to what is necessary in relation to the purpose for which
                                it is processed;
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                            ...
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                processed in a secure manner and protected against unauthorised or unlawful access or
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <p>
                            We have put in place and will maintain appropriate security measures to prevent your
                            Personal Data from being used, accessed, altered or disclosed in unauthorised way.
                        </p>
                ...
                <div class="col-12 mb-4">
                    <div class="single-faq">
                        ...
                        <ul class="list-unstyled support-list">
                            ...
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                we provide such information to other professional advisers or other trusted businesses
                                or persons for the purpose of processing Personal Data on our behalf or other legitimate
                                business purposes. We would require such parties to process such information based on
                                our instructions and in compliance with this Privacy Policy and any other appropriate
                                confidentiality and security measures; and
                            </li>
                            <li class="mb-2 d-flex align-items-start mb-4">
                                <span class="ti-check-box mr-2"></span>
                                we have a good faith belief that access, use, preservation or disclosure of such
                                information is reasonably necessary to (i) satisfy any applicable law, regulation, legal
                                process or enforceable governmental request, (ii) enforce applicable terms of service,
                                including investigation of potential violations thereof, (iii) detect, prevent, or
                                otherwise address fraud, security or technical issues, or (iv) protect against imminent
                                harm to our rights, property or safety as required or permitted by law.
                            </li>
