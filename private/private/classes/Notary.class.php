...
class Notary extends DatabaseObject
{
    ...
    protected static $db_columns = ['id', 'notary_no', 'status', 'email', 'firstname', 'lastname', 'phone', 'dob', 'gender', 'business_address', 'language', 'id_type', 'id_number', 'member', 'like_to_be', 'kin_fullname', 'kin_phone', 'kin_email', 'relationship_to_kin',  'id_card_image', 'photo','documents' ,'created_by', 'created_at', 'updated_at', 'deleted' ];
    ...
    //     if(is_blank($this->documents)) {
    //        $this->errors[] = "Kindly upload a file/document.";
    //     }
