...
class Admin extends DatabaseObject
{
    ...
    protected static $db_columns = ['id','first_name','last_name','email','profile_img','hashed_password','admin_level','account_status', 'created_at','updated_at','created_by','deleted'];
