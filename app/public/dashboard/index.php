...
<div class="row" id="analytic">
    ...
    <a href="<?php echo url_for('public/notaries/') ?>" class="col-lg-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="Notarties">Notaries</h5>
    ...
    <a href="<?php echo url_for('public/agents/') ?>" class="col-lg-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="business member">ToNote Agents</h5>
                        <h3 class="my-2 py-1"><?php echo count(Agent::find_by_undeleted()) ?? 0; ?></h3>
                        <!-- <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 11.7%</span>
                                            </p> -->
                    </div>
    ...
    <a href="<?php echo url_for('public/classroom/') ?>" class="col-lg-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="Community member">Certfied e-Notary</h5>
                        <h3 class="my-2 py-1"><?php echo count(Certificate::find_by_undeleted()); ?></h3>
                        <!-- <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 11.7%</span>
                                            </p> -->
                    </div>
    ...
    <a href="<?php echo url_for('public/trial-signup/') ?>" class="col-lg-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="Community member">30 day trial Signup</h5>
                        <h3 class="my-2 py-1"><?php echo count(FreeTrailSubscription::find_by_undeleted()); ?></h3>
                        <!-- <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 11.7%</span>
                                            </p> -->
                    </div>
